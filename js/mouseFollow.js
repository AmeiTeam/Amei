...
for (let i = 1; i <= 8; i++) {
  ...
  img.src = `./img/mouse-follow/mouse${i}.png`;
...

{
  ...
  class ImageTrail {
    constructor() {
      this.DOM = { mouseFollow: document.querySelector(".mouse-follow") };
      this.images = [];
      [...this.DOM.mouseFollow.querySelectorAll("img")].forEach((img) =>
  ...
  const preloadImages = () => {
    return new Promise((resolve, reject) => {
      imagesLoaded(document.querySelectorAll(".mouse-follow-img"), resolve);
    });
  };
